        ...
        AttackPattern(
            ...
            steps=[
                PatternStep(
                    ...
                    keyword_match="*data*|*user*|*customer*|*credential*|*secret*|*private*|*confidential*|*.csv|*.sql|*backup*|*export*|*report*|*financial*|*record*",
                    risk=5.0,
                    description="Data access: reading potentially sensitive data",
                ),
                PatternStep(
                    tool_match="write_*",
